...
<html>
    <head>
        <title>CW Download Page</title>
    </head>
    <body>
          <div>
            <?php
                $action = "download"; //sets the var $action to report, this will make the reports button on the nav bar be highlighted showing that the user is on the reports page. This happens in the header.php file
